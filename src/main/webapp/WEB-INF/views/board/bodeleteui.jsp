	...
	<div class="container">
		<div class="cover">
			...
			<div class="contents">
				...
				<div class="form">
					<form action="bodelete" method="post" enctype="multipart/form-data">
					...
					<c:forEach items="${list}" var="list">
						...
						<div class="line-title">
           					<label >제목</label>
            				<input type="text" name="BO_TITLE" placeholder="제목" class="title" value="${list.BO_TITLE}" readonly>
            			</div>
        				...
        				<div class="line-content">
           					<label>내용</label>
            				<textarea id="subject" name="BO_CONTENT" placeholder="${list.BO_CONTENT}" style="height:200px" class="content" readonly></textarea>
            				<!-- <img src="./resources/saveimage/${list.BO_PICTURE}" width="150"> -->	
       					</div>
       					<br>
